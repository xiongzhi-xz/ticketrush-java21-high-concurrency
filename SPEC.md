...
- 已补充数据库 schema、MyBatis XML 和 MySQL 仓储实现，说明见 `docs/database-schema.md`。
...
- [x] GitHub 展示补充页（30 秒看点、浏览顺序、项目摘要表达和边界说明）
...
- [x] 确认数据库表结构后创建 schema
- [x] 实现 MyBatis XML 或注解 SQL
